		...
		<form method="post" action="xoa.php" class="mt-3">
			<div class="row">
				<div class="col-12 col-md-2">
					<label class="form-label">Bạn có muốn xóa Người Dùng này?</label>
				</div>
				<div class="col-12 col-md-10">
					<input type="text" disabled="disabled" name="ten_nguoi_dung" value="<?php echo htmlspecialchars($row['ten_nguoi_dung']); ?>" class="form-control mb-3">
            ...
            if ($statement && $statement->rowCount() == 1){
                echo '<h4 class="text-success p-3">Người Dùng này đã được xóa!</h4><div><a class="btn btn-primary" href="index.php">Danh sách</a></div>';
            } else {
